<template>
  <div class="box">
    ...
    <div class="content">
      ...
      <mt-swipe :auto="4000">
        <mt-swipe-item>
          <img src="../../../assets/img/stree_sp1.png" alt>
        </mt-swipe-item>
        <mt-swipe-item>
          <img src="../../../assets/img/stree_sp2.png" alt>
        </mt-swipe-item>
        <mt-swipe-item>
          <img src="../../../assets/img/stree_sp3.png" alt>
        </mt-swipe-item>
      </mt-swipe>
      <div class="body-div">
        <div class="merchant">
          ...
          if (res.body.code === 200) {
            ...
            for (var i = 0; i < _th.wholesaleList.length; i++) {
              ...
              arr.push({
                ...
                src:
                  _th.wholesaleList[i].imgs !== null
                    ? _th.wholesaleList[i].imgs.split(",")[0]
                    : null,
                name: _th.wholesaleList[i].storeName,
                description: _th.wholesaleList[i].description,
                score: _th.wholesaleList[i].score,
                activity:
                  _th.wholesaleList[i].activity.length !== 0
                    ? _th.wholesaleList[i].activity[0].name
                    : null,
                commercialStreet: _th.wholesaleList[i].address,
                distance: parseFloat(
                  _th.wholesaleList[i].distance / 1000
                ).toFixed(2)
              });
            }
            this.imgsArr = arr;
